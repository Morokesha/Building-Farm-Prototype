...
namespace Code.Management
{
    ...
    public class FarmController : MonoBehaviour
    {
        ...
        public event Action PlantGarden;
        ...
        public void Init(IProgressService progressService,IGameFactory gameFactory,
        ...
        private void Update()
        {
            ...
            if (Input.GetMouseButton(0) && _constructionState == ConstructionState.WaitBuilt) 
                BuiltGarden();
            if (Input.GetMouseButton(0) && _constructionState == ConstructionState.Select) 
                SelectGarden();
        }
        ...
        private void OnDestroy()
        {
            ...
            _progressService.GetUpgradeService.Clear();
        }
    }
}